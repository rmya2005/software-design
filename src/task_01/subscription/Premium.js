...
var PremiumSubscription = /** @class */ (function (_super) {
    ...
    function PremiumSubscription() {
        return _super.call(this, 399, 6, ['Усі канали', 'Спортивні канали', 'Кіно преміум', 'Ексклюзивний контент'], ['Перегляд на 5 пристроях', '4K якість', 'Офлайн перегляд', 'Без реклами']) || this;
    }
    PremiumSubscription.prototype.getType = function () {
        return 'Преміум';
    };
